package pages.thirdscreenloadphoto;
...
public class ThirdScreenLoadPhoto {
    ...
    private SelenideElement inputFourthImage = $(By.xpath("//div[@page='4']//input"));
    ...
    private String path = "src/test/resources/photo/";
    ...
    public ThirdScreenLoadPhoto inputImageFour(String fouthPassportPhoto){
        loaderPhoto.waitUntil(Condition.hidden,15000);
        inputFourthImage.sendKeys(getAbsolutePath(path+fouthPassportPhoto));
        return this;
    }
    ...
    public void clickNextToFourthPage(){
        buttonNext.click();
    }
}
